...
const bool	def_new_clust	= false;		// def new clusters flag
...
const bool	def_validate	= false;		// def validation flag
...
bool			valid_dirty;			// validation is no longer valid
...
void getTrueNN()						// compute true nearest neighbors
{
	...
	valid_dirty = false;						// validation good for now
}
