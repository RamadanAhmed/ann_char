...
constexpr double ANN_DBL_MAX = std::numeric_limits<double>::max();
...
constexpr ANNidx ANN_NULL_IDX = -1;		// a NULL point index
...
constexpr ANNdist ANN_DIST_INF = ANN_DBL_MAX;
...
//----------------------------------------------------------------------
	...
	constexpr int	 ANNcoordPrec	= DBL_DIG;
#else
	constexpr int	 ANNcoordPrec	= 15;	// default precision
#endif
