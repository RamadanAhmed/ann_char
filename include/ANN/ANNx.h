...
//
	...
	bool inside(int dim, ANNpoint p);// is point p inside rectangle?
};
...
//
	...
	bool in(ANNpoint q) const	// is q inside halfspace?
	{  return  (bool) ((q[cd] - cv)*sd >= 0);  }

	bool out(ANNpoint q) const	// is q outside halfspace?
	{  return  (bool) ((q[cd] - cv)*sd < 0);  }
